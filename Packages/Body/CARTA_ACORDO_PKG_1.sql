...
--------------------------------------------------------
 ...
 (
  ...
  v_flag_fornec_homolog    pessoa.flag_fornec_homolog%TYPE;
 ...
 BEGIN
  ...
  SELECT apelido,
         ...
         nvl(perc_imposto, 0),
         flag_fornec_homolog,
         pessoa_pkg.nivel_excelencia_retornar(pessoa_id),
         pessoa_pkg.nivel_parceria_retornar(pessoa_id)
    INTO v_fornecedor,
         v_perc_bv_pdr,
         v_perc_imposto_pdr,
 ...
 BEGIN
  ...
  FOR r_fat IN c_fat
  LOOP
   -- exclui faturamentos de BVs (ainda nao faturados) associados a carta acordo
 ...
 (
  ...
  v_flag_fornec_homolog carta_acordo.flag_fornec_homolog%TYPE;
  v_resultado           NUMBER;
