...
--------------------------------------------------------
  ...
  CREATE OR REPLACE FORCE EDITIONABLE VIEW "V_PESSOAS" ("EMPRESA_ID", "PESSOA_ID", "USUARIO_ID", "APELIDO", "NOME", "GRUPO_CLIENTE", "TIPO_PESSOA", "PUBLICO_PRIVADO", "CONTATO", "CONTATO_DE", "POSSUI_DOCUMENTO", "SEXO", "DATA_NASCIMENTO", "ESTADO_CIVIL", "CARGO", "PRODUTO_CLIENTE", "CODIGO_EXTERNO_PESSOA", "PESSOA", "SIMPLES_NACIONAL", "CPOM", "CNPJ", "CPF", "INSCRICAO_ESTADUAL", "INSCRICAO_MUNICIPAL", "INSCRICAO_INSS", "RG", "DIAS_FATURAMENTO", "PAGTO_CLIENTE", "CODIGO_PROJETO", "NUMERO_PRIMEIRO_PROJETO", "DATA_ENTRADA_AGENCIA", "EMPRESA_PROJETO_PADRAO", "EMPRESA_FATURAMENTO_PADRAO", "SETOR", "BV_PADRAO", "IMPOSTO_FORNECEDOR", "NIVEL_EXCELENCIA", "NIVEL_PARCERIA", "FORNECEDOR_HOMOLOGADO", "SERVICOS", "FORNECEDOR_INTERNO", "PESSOA_ATIVA", "EMPRESA_RESPONSAVEL_PROJETO", "CODIGO_EXTERNO_EMPRESA_RESP", "EMPRESA_UTILIZADA_FATURAMENTO", "CODIGO_EXTERNO_EMPRESA_FATUR", "BANCO", "NUMERO_AGENCIA", "NUMERO_CONTA", "TIPO_CONTA", "DOC_DADOS_BANCARIOS", "TITULAR", "ENDERECO", "CIDADE", "UF", "CEP", "PAIS", "DDD_TELEFONE", "NUM_TELEFONE", "RAMAL", "FAX", "DDD_CELULAR", "NUM_CELULAR", "EMAIL", "URL", "CADASTRO_VERIFICADO", "INFO_FISCAL_VERIFICADA", "OBSERVACAO", "FLAG_ADMIN", "FLAG_ADMIN_SISTEMA", "COD_EXTERNO_PESSOA", "DATA_CRIACAO", "DATA_ALTERACAO") AS 
